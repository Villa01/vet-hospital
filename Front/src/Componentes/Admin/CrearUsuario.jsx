...
export const CrearUsuario = () => {
    ...
    const CrearCliente = async (e) => {
        ...
        const resp = await peticion('http://localhost:5000/usuarios/registrar-cliente/', data, 'POST')
        ...
        <div>
            <Card  >
                ...
                <Grid xs={15} justify='center' align="center">
                    <PersonAddIcon fontSize="large" color="danger" sx={{ fontSize: 120 }} />
                </Grid>
                <Text
                    h1
                    size={40}
                ...
                <Grid.Container gap={8} justify="flex-start">
                    ...
                    <Grid xs={12} sm={3} align="center">  <Button size="xl" auto ghost color="warning" onClick={() => CrearCliente()}>
                        Crear Cliente
                    </Button></Grid>
